...
namespace UC
{
    ...
    public class InputControlDrawer : PropertyDrawer
    {
        ...
        UnityEngine.InputSystem.PlayerInput GetPlayerInput(SerializedProperty property)
        {
            ...
            UnityEngine.InputSystem.PlayerInput playerInputReference = null;
            ...
            {
                playerInputReference = playerInputField.GetValue(targetObject) as UnityEngine.InputSystem.PlayerInput;
            }
            else
            {
                if (!alreadyWarned)
